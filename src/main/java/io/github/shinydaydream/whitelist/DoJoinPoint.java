package io.github.shinydaydream.whitelist;

import io.github.shinydaydream.whitelist.annotation.DoWhiteList;
...
public class DoJoinPoint {
    ...
    @Pointcut("@annotation(io.github.shinydaydream.whitelist.annotation.DoWhiteList)")
